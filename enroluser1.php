...
/*
http://bevan.test.pukunui.net/moodle/auth/rsa/enroluser.php?
username=renal100&
timestamp=1445917202&
hash=454119e7ee8b04617d62e21ff9f2b610&
firstname=Renal&
lastname=Society&
email=teststudent100@example.com&
course=course201

http://nen.moodle.com.au/test/auth/rsa/enroluser1.php?username=rsa125&firstname=Renal125&email=teststudent125@example.com&timestamp=1457407294&hash=454119e7ee8b04617d62e21ff9f2b610&lastname=Society&course=test101
http://nen.moodle.com.au/test/auth/rsa/enroluser1.php?username=rsa126&firstname=Renal126&email=teststudent126@example.com&timestamp=1457580006&hash=454119e7ee8b04617d62e21ff9f2b610&lastname=Society&course=test101


nen.moodle.com.au/test/auth/rsa/enroluser.php?username={{email}}&firstname={{firstname}}&email={{email}}&timestamp={{{timestamp}}}&hash=454119e7ee8b04617d62e21ff9f2b610&lastname={{surname}}&course=test101
*/
...
if ($timestamp > $config->lasttimestamp) {
    ...
    if (  1 and  ($modifier = $DB->get_record('user', array('id' => $from->id))))
    {
        $user                   = null;
